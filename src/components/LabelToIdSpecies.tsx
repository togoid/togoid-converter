...
type Props = {
  species: Signal<string | undefined>;
};

const LabelToIdSpecies = ({ species }: Props) => {
  useSignals();
        ...
        <label htmlFor="selectSpecies" className="label">
          ...
          <details className="information-tooltip">
            ...
            <div className="information-tooltip__body">
              If you cannot find a species in the pulldown list, enter the{" "}
              <a
...
export default LabelToIdSpecies;
