                  ...
                  <label htmlFor="selectSpecies" className="label">
                    ...
                    <details className="information-tooltip">
                      ...
                      <div className="information-tooltip__body">
                        If you cannot find a species in the pulldown list, enter
                        the <a href="https://www.ncbi.nlm.nih.gov/taxonomy"
                          rel="nofollow"
                          target="_blank">Taxonomy ID</a> in the right text box.
                      </div>
                    </details>
                  </label>
                  <Select
