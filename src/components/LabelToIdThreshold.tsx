...
const LabelToIdThreshold = ({ threshold }: Props) => {
  useSignals();
      ...
      <label className="label">
        ...
        <details className="information-tooltip">
          ...
          <div className="information-tooltip__body">
            Threshold can be set to a value between 0.5 and 1. When this is set
            to 1, only exact matched labels are allowed, while lower values
            allow for less strict matches.
          </div>
        </details>
      </label>
      <input
...
export default LabelToIdThreshold;
